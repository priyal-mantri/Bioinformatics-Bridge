...
**Effect on Sample Size**
9,254 rows → **5,569 rows** (3,685 participants aged <20 or >80 removed).
Age range after filter: 20–80 · Mean age: 51.5 years.
...
Actual DXAEXSTS distribution (after age filter, n=5,569):
  Code 1 (valid): 2,764 · Code 2: 16 · Code 3: 56 · Code 4: 2 · Code 5: 2 · Code 6: 407 · NaN: 2,322
